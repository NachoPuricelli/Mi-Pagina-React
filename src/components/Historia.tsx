...
function Historia() {
  return (
    <>
    <Container fluid className="py-5 bg-dark-subtle">
      <Container>
    ...
    <Container fluid className="py-5 bg-dark-subtle">
      <Container>
        <Row className="align-items-center g-4">
          ...
          <Col lg={6} md={12}>
            <img
              src="https://images.pexels.com/photos/443399/pexels-photo-443399.jpeg?cs=srgb&dl=pexels-sevenstormphotography-443399.jpg&fm=jpg"
              alt="Descripción de la imagen"
              className="img-fluid rounded shadow-lg"
              style={{
                width: "100%",
